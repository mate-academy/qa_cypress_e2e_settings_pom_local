...
describe('Settings Update Tests', () => {
  ...
  it('should update username', () => {
    ...
    settingsPage.typeNewValue(':nth-child(1) > .form-control', 'new-username');
    settingsPage.clickUpdateSettingsButton();
  });
  it('should update bio', () => {
    settingsPage.clickUpdateBio();
    settingsPage.typeNewValue(':nth-child(3) > .form-control',
      'New bio content');
      cy.wait(2000);
    settingsPage.clickUpdateSettingsButton();
  });
  it('should update email', () => {
    ...
    settingsPage.typeNewValue(':nth-child(4) > .form-control',
  ...
  it('should update password', () => {
    ...
    settingsPage.typeNewValue(':nth-child(5) > .form-control',
      newPassword, (value) => {
