        ...
        <fieldset>
          ...
          <fieldset className="form-group">
            <input
              ...
              data-cy="username-input-settings"
          ...
          <fieldset className="form-group">
            <input
              ...
              data-cy="new-password-input-settings"
          ...
          <button
            ...
            type="submit"
            data-cy="update-settings-submit-btn"
            disabled={isLoading}
          >
            Update Settings
          </button>
